...
![Agent query about HQ](./images/31ai59.png?raw=true "Agent query about HQ") 
...
![Running the RAG agent](./images/31ai60.png?raw=true "Running the RAG agent") 
...
![Running the updated RAG agent](./images/31ai61.png?raw=true "Running the updated RAG agent")
